...
const (
	...
	UPDATE_CATEGORY_LOAN      = "UPDATE category_loan SET categoryLoan_name = $1, updated_at= $2 WHERE id = $3"
	DELETE_CATEGORYLOAN       = "DELETE FROM category_loan WHERE id = $1"
	GET_CATEGORY_UPDATE_ID    = "SELECT id FROM category_product WHERE id = $1"
)
